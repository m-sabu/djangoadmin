    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(default=b'se', max_length=2)),
                ('language', models.CharField(default=b'sv', max_length=2)),
                ...
                ('status', enumerify.fields.SelectIntegerField(default=0, db_index=True, choices=[(0, b'Invited'), (1, b'Active'), (2, b'Removed')])),
